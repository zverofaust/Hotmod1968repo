	...
	{Repeat = 0, --infinite
		Units = {
			...
			-- Infantry
				...
				{priority = 1.0, type = {"Infantry", "Team", "AT",}, unit = "single_at_early(csa)"},
				{priority = 1.0, type = {"Infantry", "Team", "AT",}, unit = "single_at(csa)"},
				{priority = 1.0, type = {"Infantry", "Team", "AT",}, unit = "single_lat_early(csa)"},
				{priority = 1.0, type = {"Infantry", "Team", "AT",}, unit = "single_lat(csa)"},
				{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_mg(csa)"},
				{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_grenadier_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_scout(csa)"},
				{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_flamer(csa)"},
				{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_marksman(csa)"},
				{priority = 0.2, type = {"Infantry", "Team",}, unit = "single_sniper(csa)"},
				{priority = 0.2, type = {"Infantry", "Team",}, unit = "single_sapperap(csa)"},
				{priority = 0.2, type = {"Infantry", "Team",}, unit = "single_sapperat(csa)"},
				
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_reservist_con_early(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_reservist_fireteamap_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad", "AT",}, unit = "squad_reservist_fireteamat_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_reservist_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_reservist_moto2_con(csa)"},
				
				
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_natguard_con_early(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_natguard_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_natguard_moto2_con(csa)"},
				
				
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_rifle_con_early(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_rifle_fireteamap_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad", "AT",}, unit = "squad_rifle_fireteamat_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_rifle_con(csa)"},
				{priority = 0.5, type = {"Infantry", "Squad",}, unit = "squad_weapon_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_rifle_moto_con(csa)"},
				{priority = 0.5, type = {"Infantry", "Squad",}, unit = "squad_weapon_moto_con(csa)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_rifle_m16_moto_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_weapon_m16_moto_con(csa)"},
				
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_acav_moto_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_acav_weapon_moto_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_acav_m16_moto_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_acav_m16_weapon_moto_con(csa)"},
				
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_aircav_recon_con(csa)"},
				{priority = 0.5, type = {"Infantry", "Squad",}, unit = "squad_aircav_fireteam_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_aircav_con(csa)"},
				
				
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_usmc_fireteam_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_usmc_con(csa)"},
				{priority = 0.5, type = {"Infantry", "Squad",}, unit = "squad_usmc_mg_con(csa)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_usmc_fireteam_con(csa)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_usmc_moto_con(csa)"},
				{priority = 0.5, type = {"Infantry", "Squad",}, unit = "squad_usmc_m16_moto_con(csa)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_ranger_demo_con(csa)"},
