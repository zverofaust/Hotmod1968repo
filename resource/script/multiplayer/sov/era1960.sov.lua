Purchases["era1960.sov"] = {
	{Repeat = 0,  --infinite
		Units = {
			...
			{priority = 1.0, type = {"Class3", "Doctrine", "Armored", "MG", }, unit = "doctrine_squad_guards_moto(sov)"},
			...
			{priority = 1.0, type = {"Class3", "Doctrine", "Armored", "MG", "Tier2",}, unit = "doctrine_squad_guards_moto2(sov)"},
			...
			{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "doctrine_squad_guards_tank(sov)"},
