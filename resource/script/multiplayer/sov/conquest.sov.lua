	...
	{Repeat = 0, --infinite
		Units = {
			...
			-- Infantry
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_conscript_full_con(sov)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_conscript_moto_con(sov)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_conscript_moto2_con(sov)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_conscript_mech_con(sov)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_conscript_mech2_con(sov)"},
			...
			--Air Assets
				--{priority = 1.0, type = {"Plane", "Airstrike", "Support",}, unit = "mil_mi4"},
