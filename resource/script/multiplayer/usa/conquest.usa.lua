	...
	{Repeat = 0, --infinite
		Units = {
			...
			-- Cannons	
				...
				--Infantry_Support
				{priority = 1.0, type = {"Cannon", "Support",}, unit = "m116_packhbow"},
				--Artillery
			...
			--APCs/BTRs
				...
				{priority = 1.0, {"Armored", "AT",}, unit = "m113_m40"},
				{priority = 1.0, {"Armored", "AT",}, unit = "m113_acav_m40"},
				
				{priority = 1.0, {"Armored", "MG",}, unit = "m114a1"},
				{priority = 1.0, {"Armored", "MG",}, unit = "m114a2"},
				{priority = 1.0, {"Armored", "Mortar",}, unit = "m125"},
				{priority = 1.0, {"Armored", "Mortar",}, unit = "m106"},
				{priority = 1.0, {"Armored", "Mortar",}, unit = "m106_acav"},
				{priority = 1.0, {"Armored", "Support",}, unit = "m132_zippo"},
				
			--Tanks
				{priority = 1.0, {"Tank", "Light",}, unit = "m41_early"},
				{priority = 1.0, {"Tank", "Light",}, unit = "m41"},
				{priority = 1.0, {"Tank", "Light", "AT",}, unit = "m56"},
				{priority = 1.0, {"Tank", "Light", "AT", "Support",}, unit = "m551"},
				{priority = 1.0, {"Tank", "Light", "AT", "Support",}, unit = "m551_acav"},
				{priority = 1.0, {"Tank", "Light", "AT", "Support",}, unit = "m50"},
