Purchases["campaign_capture_the_flag"] = {
	{
		...
		Units = {
			...
			["sov"] = {--Soviet Union
			--Infantry
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_conscript_con(sov)"},
				{priority = 2.0, class = UnitClass.Infantry, period = "mid", unit = "squad_maneuv_con(sov)"},
				{priority = 2.0, class = UnitClass.Infantry, period = "mid", unit = "squad_fireteam_con(sov)"},
				{priority = 2.0, class = UnitClass.Infantry, period = "mid", unit = "squad_rifle_con(sov)"},
				{priority = 2.0, class = UnitClass.Infantry, period = "mid", unit = "squad_guards_con(sov)"},
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_conscript_moto_con(sov)"},
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_rifle_moto_con(sov)"},
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_guards_moto_con(sov)"},
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_guards_moto2_con(sov)"},
			...
			--Tanks_light
				...
				{priority = 1.0, class = UnitClass.ATTank, period = "mid", unit = "asu57"},
			...
			--SPG
				{priority = 1.0, class = UnitClass.ArtilleryTank, period = "mid", unit = "2s3"},
				{priority = 1.0, class = UnitClass.ArtilleryTank, period = "mid", unit = "bm-21_grad"}
			},
			["usa"] = {--United States
			--Infantry
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_reservist_con(usa)"},
				{priority = 2.0, class = UnitClass.Infantry, period = "mid", unit = "squad_fireteamAP_con(usa)"},
				{priority = 2.0, class = UnitClass.ATInfantry, period = "mid", unit = "squad_fireteamAT_con(usa)"},
				{priority = 2.0, class = UnitClass.Infantry, period = "mid", unit = "squad_rifle_con(usa)"},
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_rifle_moto_con(usa)"},
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_weapon_moto_con(usa)"},
				
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_lrrp_con(usa)"},
				{priority = 1.0, class = UnitClass.Infantry, period = "mid", unit = "squad_ranger_con(usa)"},
			...
			--SPG
				{priority = 0.5, class = UnitClass.ArtilleryTank, period = "mid", unit = "m108"},
				{priority = 0.5, class = UnitClass.ArtilleryTank, period = "mid", unit = "m109"},
