-- Purchases for Dynamic Campaign mode AI
Purchases["campaign_capture_the_flag"] = {
	{
		...
		Units = {
			...
			--Tanks_medium
				...
				{priority = 0.25, class = UnitClass.Tank, unit = "ot-55"},
			...
			--Tanks_medium
				...
				{priority = 1.0, class = UnitClass.Tank, unit = "m48"},
				{priority = 1.0, class = UnitClass.Tank, unit = "m48a1"},
				{priority = 0.5, class = UnitClass.Tank, unit = "m67_zippo"},
				{priority = 1.0, class = UnitClass.Tank, unit = "m48a3"},
				{priority = 1.0, class = UnitClass.Tank, unit = "m60_patton"},
			...
			--Tanks_light
				{priority = 2.0, class = UnitClass.ArtilleryTank, unit = "su76_prc"},
				{priority = 1.0, class = UnitClass.Tank, unit = "type62_lt"},	
			--Tanks_medium
